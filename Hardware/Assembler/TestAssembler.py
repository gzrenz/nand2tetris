...
class HackAssemblerTestRun(unittest.TestCase): 
    """Tests the assembler using file max.asm"""

    assembler = Assembler('data/max/Max.asm')

    def test_firstPass_labels(self): 
        self.assembler.firstPass() 
        # print(self.assembler.symbolDict)
    ...
    def test_secondPass_variables(self): 
        self.assembler.secondPass() 
        
class HackAssemblerAddTestRun(unittest.TestCase): 
    """Test in convert add asm code to binary hack code"""
